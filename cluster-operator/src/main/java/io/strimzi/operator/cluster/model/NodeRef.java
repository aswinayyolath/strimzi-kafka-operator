 ...
 * @param clusterId Id of the cluster (in a stretched cluster scenario) where the node lives
 ...
 */
public record NodeRef(String podName, int nodeId, String poolName, String clusterId, boolean controller, boolean broker) {
    @Override
     ...
     * @param broker        Identifies if this node is a broker or not
     */
    public NodeRef(String podName, int nodeId, String poolName, boolean controller, boolean broker) {
        this(podName, nodeId, poolName, null, controller, broker);
    }
}
