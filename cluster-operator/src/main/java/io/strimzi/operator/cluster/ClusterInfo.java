 ...
 * required by the Cluster Operator to manage Kafka nodes across
 * clusters.
 *
 * @param clusterId   The ID of the remote Kubernetes cluster.
 * @param apiUrl      The URL of the remote Kubernetes API server.
 * @param secretName  The name of the Kubernetes Secret used for
 *                    authentication.
 */
public record ClusterInfo(String clusterId, String apiUrl,
                          String secretName) { }
