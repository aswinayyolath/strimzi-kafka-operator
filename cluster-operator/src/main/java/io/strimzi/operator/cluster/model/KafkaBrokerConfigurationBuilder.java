...
public class KafkaBrokerConfigurationBuilder {
    ...
    private String customAdvertisedListeners;
    private String customControllerQuorumVoters;
    ...
    /**
     * Sets custom advertised listeners string for stretch cluster mode.
     * When set, this overrides the standard advertised.listeners generation.
     *
     * @param customAdvertisedListeners The custom advertised listeners string from the stretch networking provider
     * @return Returns the builder instance
     */
    public KafkaBrokerConfigurationBuilder withCustomAdvertisedListeners(String customAdvertisedListeners) {
        this.customAdvertisedListeners = customAdvertisedListeners;
        return this;
    }

    /**
     * Sets custom controller.quorum.voters string for stretch cluster mode.
     * When set, this overrides the standard quorum voters generation.
     *
     * @param customControllerQuorumVoters The custom quorum voters string from the stretch networking provider
     * @return Returns the builder instance
     */
    public KafkaBrokerConfigurationBuilder withCustomControllerQuorumVoters(String customControllerQuorumVoters) {
        this.customControllerQuorumVoters = customControllerQuorumVoters;
        return this;
    }
    ...
    public KafkaBrokerConfigurationBuilder withListeners(
        ...
        if (customAdvertisedListeners != null) {
            writer.println("advertised.listeners=" + customAdvertisedListeners);
        } else if (!advertisedListeners.isEmpty()) {
